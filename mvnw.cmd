...
echo.
echo Could not download %WRAPPER_JAR%, please check your internet connection.
exit /b 1
...
@REM check for post script from one of the users config files
